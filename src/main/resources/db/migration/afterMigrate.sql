...
SELECT pg_get_serial_sequence('estado', 'id');
SELECT pg_get_serial_sequence('cidade', 'id');
SELECT pg_get_serial_sequence('cozinha', 'id');
SELECT pg_get_serial_sequence('forma_pagamento', 'id');
SELECT pg_get_serial_sequence('grupo', 'id');
SELECT pg_get_serial_sequence('produto', 'id');
SELECT pg_get_serial_sequence('restaurante', 'id');
SELECT pg_get_serial_sequence('usuario', 'id');
SELECT pg_get_serial_sequence('permissao', 'id');
